...
class SvgRatingBarReviewSmallest @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null,
    ...
    private fun getBitmapDrawableFromVectorDrawable(drawable: Drawable): BitmapDrawable {
        ...
        return BitmapDrawable(resources, addWhiteBorder(bitmap,4))
    }
