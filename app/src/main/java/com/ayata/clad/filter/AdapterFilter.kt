...
class AdapterFilter(data: List<ModelFilter>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HomeRecyclerViewHolder {
        ...
        return when (viewType) {
            ...
            R.layout.item_recycler_filter -> HomeRecyclerViewHolder.ColorViewHolder(
                ItemRecyclerFilterBinding.inflate(
                    LayoutInflater.from(parent.context),
                    parent,
                    false
    ...
    override fun onBindViewHolder(holder: HomeRecyclerViewHolder, position: Int) {
        when (holder) {
            is HomeRecyclerViewHolder.TitleViewHolder -> holder.bind(items[position] as MyFilterRecyclerViewItem.Title,itemFilterClick)
    ...
    override fun getItemViewType(position: Int): Int {
        return when (items[position]) {
            ...
            is MyFilterRecyclerViewItem.Color -> R.layout.item_recycler_filter
        }
    }
    ...
    sealed class HomeRecyclerViewHolder(binding: ViewBinding) :
        ...
        class TitleViewHolder(private val binding: ItemRecyclerFilterBinding) :
            ...
            fun bind(item: MyFilterRecyclerViewItem.Title, itemFilterClick: ((MyFilterRecyclerViewItem.Title) -> Unit)?) {
                with(item) {
        ...
        class ColorViewHolder(private val binding: ItemRecyclerFilterBinding) :
            HomeRecyclerViewHolder(binding) {
