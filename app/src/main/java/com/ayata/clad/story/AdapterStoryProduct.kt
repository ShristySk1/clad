...
internal class AdapterStoryProduct(private var context:Context?,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view= LayoutInflater.from(context).inflate(R.layout.recycler_story_product,parent,false)
...
//       val progressBar=itemView.findViewById<ProgressBar>(R.id.progressBar)
       fun clickView(){
           itemView.setOnClickListener {
               onItemClickListener.onProductClick(listItems[adapterPosition],adapterPosition)
           }
       }
