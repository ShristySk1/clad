...
internal class AdapterShippingAddress(private var context: Context?, private var listItems:List<ModelShippingAddress>,
                                      private val onItemClickListener: OnItemClickListener
)
    : RecyclerView.Adapter<AdapterShippingAddress.MyViewHolder>(){
