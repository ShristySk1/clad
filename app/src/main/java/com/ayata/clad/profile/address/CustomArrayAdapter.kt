...
class CustomArrayAdapter(
    ...
    private val values: List<ModelTest>,
) : ArrayAdapter<ModelTest>(context, layoutResource, values) {

    override fun getItem(position: Int): ModelTest = values[position]
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        val view = createViewFromResource(convertView, parent, R.layout.spinner_custom_dialog)
    ...
    private fun bindData(value: ModelTest, view: TextView): TextView {
        view.text = value.state
        return view
    }
}